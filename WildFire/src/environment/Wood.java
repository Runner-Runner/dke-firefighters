...
{
	//Increases by rain decreases by time and fire in neighborhood fire cannot enter if > 0 (threshold)
	private double wetness;	
	//Life points - depends on material 
	private double health;	
	//Defines material factor, how much water can be stored, how fast it transpires and how hot this material can burn
